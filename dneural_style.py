...
def build_parser():
    ...
    # this is the dir to the image which will determine the 'style'
    parser.add_argument('--styles',
            dest='styles',
            nargs='+', help='one or more style images',
            metavar='STYLE', required=True)
    # this sets the output image target.
    parser.add_argument('--output',
            dest='output', help='output path',
            metavar='OUTPUT', required=True)
    #this sets the number of itterations to converge on the loss function
    ...
    # this allows the user to output 'check point' output images
    ...
    parser.add_argument('--rStyle', action='store_true',
            dest='rStyle', help='Reconstructs the style image')
    
    parser.add_argument('--rContent',action='store_true',
            dest='rContent', help='Reconstructs the content image')
    
    
    
    parser.add_argument('--label',
            dest='label', help='labels tensor board data',
            metavar='LABEL', required=True)    
